  ...
  fetch(form.action, {
    ...
    .then(result => {
      if (result.snap_token) {
        ...
        saveErrorDataToSession({ code: 'ORDER_CREATION_FAILED', message: 'Terjadi kesalahan saat membuat order.' });
    ...
    .catch(error => {
      ...
      saveErrorDataToSession({ code: 'SYSTEM_ERROR', message: 'Terjadi kesalahan sistem. Silakan coba lagi nanti.' });
      window.location.href='/transaction/failed';
    })
    .finally(() => {
