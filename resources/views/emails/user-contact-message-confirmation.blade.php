...
<html lang="en">
  <head>
    ...
    <title>Konfirmasi Pengiriman Pesan</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      <div class="header">
        <h1>Konfirmasi Pengiriman Pesan</h1>
      </div>
      <div class="content">
        <p>Halo {{ $contactMessage->name }},</p>
        <p>Terima kasih telah menghubungi kami melalui formulir kontak kami. Berikut adalah detail pesan yang Anda
          kirimkan:</p>
        ...
        <p>Kami akan segera merespons pesan Anda. Jika Anda memiliki pertanyaan lebih lanjut, jangan ragu untuk
          menghubungi kami kembali.</p>
      </div>
      <div class="footer">
