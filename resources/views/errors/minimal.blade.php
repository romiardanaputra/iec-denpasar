...
<html lang="en">
  ...
  <body class="antialiased">
    <section class="bg-white dark:bg-gray-900 min-h-screen flex items-center mx-auto max-w-screen-xl gap-8 ">
      <div>
        <img class="size-full" src="{{ asset('storage/assets/vectors/undraw_no-data.svg') }}" alt="no-data-vectors">
      </div>
      <div class="py-8 px-4 lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm ">
          ...
          <a href="{{ route('dashboard') }}"
            class="inline-flex text-white bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">Back
            to Homepage</a>
        </div>
      </div>
    </section>
