    ...
    <ul class="flex flex-col pl-0 mb-0">
      ...
      <li class="mt-0.5 w-full">
        ...
        <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
          ...
          href="{{ url('schedule') }}">
          <div
            class="{{ Request::is('schedule') ? ' bg-blue-800' : 'bg-white' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <x-lucide-calendar-check class="size-4 {{ Request::is('schedule') ? 'text-white' : 'text-slate-800' }}" />
          </div>
          <span
            class="{{ Request::is('rtl') ? 'mr-1' : 'ml-1' }} duration-300 opacity-100 pointer-events-none ease-soft">Course
            Schedule</span>
        </a>
        <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
          ...
          <div
            ...
            <x-lucide-book-plus class="size-4" />
          </div>
          <span
        ...
        <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
          ...
          <span
            class="{{ Request::is('rtl') ? 'mr-1' : 'ml-1' }} duration-300 opacity-100 pointer-events-none ease-soft">Selected
            Course</span>
        </a>
      </li>
      <li class="w-full mt-4">
