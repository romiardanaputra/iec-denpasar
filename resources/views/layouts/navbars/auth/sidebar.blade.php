<aside
  class="max-w-52 ease-nav-brand fixed inset-y-0 block w-full flex-wrap items-center justify-between overflow-y-auto  border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 -translate-x-52 xl:translate-x-0 xl:bg-transparent z-[1000]"
  id="sidenav-main">
  <div class="h-19.5">
