<section class="relative z-20 overflow-hidden bg-white dark:bg-gray-900 pt-20 pb-12 lg:pt-24 lg:pb-[90px]">
  <div class="container mx-auto">
    <div class="flex flex-wrap -mx-4">
      <div class="w-full px-4">
        <div class="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
          ...
          <h2 class="text-gray-900 dark:text-white mb-4 text-xl font-semibold sm:text-[40px]/[48px]">
    ...
    <div class="flex flex-wrap -mx-4">
      ...
      @forelse ($faqs as $index => $faq)
        <div class="w-full px-4 lg:w-1/2">
          <div
            ...
            <button class="flex w-full text-left faq-btn" onclick="toggleFaq({{ $index }})" aria-expanded="false"
      ...
      @empty
        <p>tidak ada data faq ditemukan</p>
      @endforelse
    </div>
  </div>
</section>
...
@section('js_custom')
  <script>
    function toggleFaq(index) {
      ...
      var button = document.querySelector(`.faq-btn[onclick="toggleFaq(${index})"]`);
