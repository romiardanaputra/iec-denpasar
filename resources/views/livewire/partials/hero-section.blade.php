<section class="pt-8 lg:pt-32 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-cover">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
    <h1 class="max-w-2xl mx-auto text-center font-bold text-4xl text-gray-900 mb-5 md:text-5xl leading-[50px]">
      {{ $title }}
      <span class="text-blue-600"> {{ $highlightedText }} </span>
    </h1>
    <p class="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9">
      {{ $subTitle }}
    </p>
    <a href="{{ $ctaButton }}"
      class="w-full md:w-auto mb-14 inline-flex items-center justify-center py-3 px-7 text-base font-semibold text-center text-white rounded-full bg-blue-600 shadow-xs hover:bg-blue-700 transition-all duration-500">
      Lihat Selengkapnya
