    ...
    (function (h, a) {
      ...
      return (function (l) {
        ...
        return (
          ...
          (a.d = function (c, s, f) {
            a.o(c, s) ||
              Object.defineProperty(c, s, { enumerable: !0, get: f });
          }),
          (a.r = function (c) {
            typeof Symbol < "u" &&
              Symbol.toStringTag &&
            ...
            N = (function () {
              ...
              return (
                ...
                (e.prototype.getPath = function (t, n) {
                  return (
                    this.getRoot(n) + "/" + t + this.options.suffix + ".js"
                  );
                }),
                e
              );
          ...
          var Fr = m.Transports,
            ...
            Wr = function (e) {
              if (typeof m.getAuthorizers()[e.transport] > "u")
                throw (
                  "'" + e.transport + "' is not a recognized auth transport"
                );
              return function (t, n) {
                var r = Jr(t, e);
          ...
          },
          {
            ...
            value: function () {
              ...
              axios.interceptors.request.use(function (c) {
                return (
                  a.socketId() && (c.headers["X-Socket-Id"] = a.socketId()), c
                );
              });
            },
          },
            ...
            value: function () {
              ...
              typeof jQuery.ajax < "u" &&
                jQuery.ajaxPrefilter(function (c, s, f) {
                  a.socketId() &&
                    f.setRequestHeader("X-Socket-Id", a.socketId());
                });
            },
          },
          {
