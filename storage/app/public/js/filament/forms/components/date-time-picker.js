      ...
      return function ($) {
        ...
        return (
          (function (S) {
            ...
            if (b !== void 0) {
              var T = S.hours;
              b ? T < 12 && (S.hours += 12) : T === 12 && (S.hours = 0),
                delete S.afternoon;
            }
          })(H),
          H
          ...
          H && (U = q[2]),
            ...
            (this.$d = (function (p, M, S, b) {
              try {
                ...
                return Z
                  ? new Date(
                      Date.UTC(ee, le, X, pe, De, Le, ve + 60 * Z.offset * 1e3),
                    )
                  : S
        ...
        return (
          ...
          (h.$set = function (c, p) {
            ...
            if (S === d || S === y) {
              ...
              N.$d[T](I),
                N.init(),
                (this.$d = N.set(l, Math.min(this.$D, N.daysInMonth())).$d);
            } else T && this.$d[T](I);
  ...
  (function (n, t) {
    typeof Xt == "object" && typeof Bt < "u"
      ...
      : typeof define == "function" && define.amd
        ? define(["dayjs"], t)
        : ((n =
            typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_th =
            t(n.dayjs));
  })(Xt, function (n) {
    "use strict";
    function t(e) {
...
var Ai = function (t) {
    ...
    if (typeof s == "string" && !/Z$/i.test(s)) {
      ...
      if (e) {
        ...
        return i
          ? new Date(
              Date.UTC(e[1], r, e[3] || 1, e[4] || 0, e[5] || 0, e[6] || 0, a),
            )
    ...
    return (
      ...
      (t.$set = function (i, e) {
        ...
        if (a === R || a === K) {
          ...
          _.$d[o](d),
            _.init(),
            (this.$d = _.set(se, Math.min(this.$D, _.daysInMonth())).$d);
        } else o && this.$d[o](d);
        return this.init(), this;
      }),
      (t.set = function (i, e) {
