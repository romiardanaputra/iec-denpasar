      ...
      if (Br == null) {
        ...
        V(e, _("span", [t, document.createTextNode("x")])),
          e.firstChild.offsetHeight != 0 &&
            (Br = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(s && h < 8));
      }
      var n = Br
        ? _("span", "\u200B")
        : _(
      ...
      return {
        ...
        token: function (b, S) {
          return (
            ...
            b.start == S.basePos &&
              ((S.baseCur = p.token(b, S.base)), (S.basePos = b.pos)),
...
var Qn = Ke((Os, Ps) => {
  (function (o) {
    ...
    function h(T, x) {
      for (var c in T)
        for (
          var d = x[c] || (x[c] = []), w = T[c], E = w.length - 1;
          E >= 0;
          E--
        )
          d.unshift(w[E]);
      ...
      function (p, v) {
        ...
        function re(q, L) {
            ...
            for (L.list = null; qe < L.listStack[L.listStack.length - 1]; )
              L.listStack.pop(),
                L.listStack.length
                  ...
                  : (L.list = !1);
            L.list !== !1 &&
              (L.indentationDiff = qe - L.listStack[L.listStack.length - 1]);
          }
          var Se =
              !ze &&
              !Ee &&
            ...
            je =
              (L.list === !1 || Ee || ze) && L.indentation <= Oe && q.match(g),
            Ze = null;
          if (
            L.indentationDiff >= 4 &&
            (pe || L.prevLine.fencedCodeEnd || L.prevLine.header || ze)
          )
          ...
          if (
            ...
            if (je)
              return q.skipToEnd(), (L.hr = !0), (L.thisLine.hr = !0), s.hr;
        ...
        function D(q) {
          ...
          if (q.taskClosed)
            return L.push("property"), L.length ? L.join(" ") : null;
          if (
            (q.linkHref
          ...
          return (
            q.trailingSpaceNewLine
              ...
              : q.trailingSpace &&
                L.push("trailing-space-" + (q.trailingSpace % 2 ? "a" : "b")),
        ...
        function j(q, L) {
          ...
          if (pe === "]" && L.imageAltText) {
            ...
            var je = D(L);
            return (
              (L.imageAltText = !1), (L.image = !1), (L.inline = L.f = _), je
            );
          }
          if (pe === "[" && !L.image)
            return (
        ...
        var xe = {
          ...
          token: function (q, L) {
            if (((L.formatting = !1), q != L.thisLine.stream)) {
              if (((L.header = 0), (L.hr = !1), q.match(/^\s*$/, !0)))
                return ee(L), null;
              if (
                ...
                if (((L.indentation = de), (L.indentationDiff = null), de > 0))
                  return null;
              }
            }
            return L.f(q, L);
    ...
    o.defineMode("jinja2", function () {
      ...
      function s(h, g) {
        ...
        if (g.intag) {
          ...
          if (g.instring)
            return T == g.instring && (g.instring = !1), h.next(), "string";
          ...
          if (g.inbraces > 0 && T == ")") h.next(), g.inbraces--;
            ...
            if (
              !g.lineTag &&
              (h.match(g.intag + "}") || (h.eat("-") && h.match(g.intag + "}")))
            )
      ...
      function (C, b) {
        ...
        function T(c, d, w) {
          ...
          if (c.peek() == "{") {
            ...
            return (
              (d.context = new p(o.startState(s, E), s, 0, d.context)), null
            );
          }
          if (w.depth == 1) {
            if (c.peek() == "<")
        ...
        function xe(q, L) {
          for (; !q.eol(); )
            if ((q.eatWhile(/[^'"\{\}\\]/), q.eat("\\"))) {
              ...
              if (q.match("{{")) return B;
              if (q.match("{", !1))
                return (L.tokenize = le(0)), q.current() ? B : L.tokenize(q, L);
              if (q.match("}}")) return B;
              if (q.match("}")) return T;
              q.eat(/['"]/);
            }
  ...
  (function (o) {
    ...
    o.defineMode("shell", function () {
      ...
      function s(d, w) {
        ...
        if (z === "'" || z === '"' || z === "`")
          return (
            w.tokens.unshift(h(z, z === "`" ? "quote" : "string")), c(d, w)
          );
        if (z === "#")
          return E && d.eat("!")
            ? (d.skipToEnd(), "meta")
...
function bn(o) {
  ...
  if (
    (p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = x), S)
  ) {
      ...
      if (((o = o || this.options.toolbar), !(!o || o.length === 0))) {
        ...
        for (C.toolbar = o, p = 0; p < o.length; p++)
          if (
            ...
            !(
              (o[p].name == "fullscreen" || o[p].name == "side-by-side") &&
              ra()
            )
          ) {
            if (o[p] === "|") {
    ...
    Te.prototype.createStatusbar = function (o) {
      ...
      if (!(!o || o.length === 0)) {
        ...
        for (b = 0; b < o.length; b++)
          if (
            ((S = void 0), (s = void 0), (h = void 0), typeof o[b] == "object")
          )
            C.push({
  ...
  return {
    ...
    getToolbar: function () {
      ...
      return (
        ...
        ["heading"].some((w) => x.includes(w)) &&
          ["blockquote", "codeBlock", "bulletList", "orderedList"].some((w) =>
            x.includes(w),
          ) &&
          d.push("|"),
