var po = "2.1.12",
  ...
  fi = (i) => document.activeElement !== i && Tt(i, document.activeElement),
  Tt = function (i, t) {
    if (i && t)
      for (; t; ) {
        if (t === i) return !0;
...
var So = 0,
  ...
  U = class extends dt {
    ...
    merge(t) {
      return new U(Oo(this.values, Fo(t)));
    }
    slice(t) {
      let e = {};
      return (
...
var {
  ...
  { freeze: V, seal: Y, create: Vr } = Object,
...
var Ne = G(Array.prototype.forEach),
  or = G(Array.prototype.pop),
  oe = G(Array.prototype.push),
  _e = G(String.prototype.toLowerCase),
  Fn = G(String.prototype.toString),
  sr = G(String.prototype.match),
  se = G(String.prototype.replace),
  _o = G(String.prototype.indexOf),
  jo = G(String.prototype.trim),
...
var lr = V([
  ...
  Ve = (function i() {
    let t =
        arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ns(),
      e = (a) => i(a);
    if (
      ((e.version = "3.2.3"),
      (e.removed = []),
    ...
    let {
      ...
      Cn = function () {
        ...
        if (!Vt || Vt !== a) {
          if (
            ...
            (N = X(a, "ALLOWED_TAGS") ? b({}, a.ALLOWED_TAGS, I) : ki),
            (O = X(a, "ALLOWED_ATTR") ? b({}, a.ALLOWED_ATTR, I) : Ri),
            (xn = X(a, "ALLOWED_NAMESPACES")
              ? b({}, a.ALLOWED_NAMESPACES, Fn)
              : co),
            (An = X(a, "ADD_URI_SAFE_ATTR")
              ? b(Rt(Pi), a.ADD_URI_SAFE_ATTR, I)
              : Pi),
            (Oi = X(a, "ADD_DATA_URI_TAGS")
              ? b(Rt(Fi), a.ADD_DATA_URI_TAGS, I)
              : Fi),
            (Wt = X(a, "FORBID_CONTENTS") ? b({}, a.FORBID_CONTENTS, I) : Ii),
            (te = X(a, "FORBID_TAGS") ? b({}, a.FORBID_TAGS, I) : {}),
            (gn = X(a, "FORBID_ATTR") ? b({}, a.FORBID_ATTR, I) : {}),
            ...
            jt &&
              ((N = b({}, cr)),
              (O = []),
              jt.html === !0 && (b(N, lr), b(O, ur)),
              jt.svg === !0 && (b(N, Pn), b(O, _n), b(O, Ie)),
              jt.svgFilters === !0 && (b(N, Mn), b(O, _n), b(O, Ie)),
              jt.mathMl === !0 && (b(N, Bn), b(O, hr), b(O, Ie))),
            a.ADD_TAGS && (N === ki && (N = Rt(N)), b(N, a.ADD_TAGS, I)),
            a.ADD_ATTR && (O === Ri && (O = Rt(O)), b(O, a.ADD_ATTR, I)),
            a.ADD_URI_SAFE_ATTR && b(An, a.ADD_URI_SAFE_ATTR, I),
            a.FORBID_CONTENTS &&
              (Wt === Ii && (Wt = Rt(Wt)), b(Wt, a.FORBID_CONTENTS, I)),
            vn && (N["#text"] = !0),
            ...
            k === void 0 &&
              (k = (function (g, h) {
                ...
                try {
                  ...
                  return (
                    console.warn(
                      "TrustedTypes policy " + f + " could not be created.",
                    ),
                    null
                  );
                }
              })(tt, o)),
              k !== null && typeof ot == "string" && (ot = k.createHTML(""));
          V && V(a), (Vt = a);
        }
      },
      Bi = b({}, [...Pn, ...Mn, ...Uo]),
      ...
      ji = function (a) {
        ...
        if (!g || !g.documentElement) {
          ...
          try {
            g.documentElement.innerHTML = yn ? ot : v;
          } catch {}
        }
    ...
    let Vi = function (a) {
        let g = null;
        if ((at(J.beforeSanitizeElements, a, null), En(a))) return et(a), !0;
        let h = I(a.nodeName);
        if (
          (at(J.uponSanitizeElement, a, { tagName: h, allowedTags: N }),
          (a.hasChildNodes() &&
        ...
        for (; v--; ) {
          ...
          if (zi(Ji, nt, B)) {
            if (
              ...
              switch (tt.getAttributeType(Ji, nt)) {
                case "TrustedHTML":
                  B = k.createHTML(B);
                  break;
            ...
            try {
              D ? a.setAttributeNS(D, f, B) : a.setAttribute(f, B),
                En(a) ? et(a) : or(e.removed);
            } catch {}
          }
        }
      ...
      mo = function a(g) {
        let h = null,
          v = Wi(g);
        for (at(J.beforeSanitizeShadowDOM, g, null); (h = v.nextNode()); )
    ...
    return (
      (e.sanitize = function (a) {
        ...
        if (
          (fn || Cn(g), (e.removed = []), typeof a == "string" && (ee = !1), ee)
        ) {
          if (a.nodeName) {
            let nt = I(a.nodeName);
            if (!N[nt] || te[nt])
          ...
          if (((h = ji(a)), !h)) return _t ? null : Se ? ot : "";
        }
        h && bn && et(h.firstChild);
        let D = Wi(ee ? a : h);
        for (; (A = D.nextNode()); )
          Vi(A), Hi(A), A.content instanceof s && mo(A.content);
        if (ee) return a;
        if (_t) {
          if (Ee)
          ...
          return (
            (O.shadowroot || O.shadowrootmode) && (f = ro.call(r, f, !0)), f
          );
        }
        ...
        return (
          St &&
            ...
            _(qr, h.ownerDocument.doctype.name) &&
            (lt =
              "<!DOCTYPE " +
              h.ownerDocument.doctype.name +
              `>
` +
      ...
      (e.setConfig = function () {
        Cn(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}),
          (fn = !0);
      }),
...
var is = "style href src width height language class".split(" "),
  ...
  Kt = class extends R {
    ...
    elementIsRemovable(t) {
      if (t?.nodeType === Node.ELEMENT_NODE)
        return this.elementIsForbidden(t) || this.elementIsntSerializable(t);
    }
  ...
  be = class extends gt {
    ...
    createCaptionElement() {
      let t = p({ tagName: "figcaption", className: ft.attachmentCaption }),
    ...
    getClassName() {
      let t = [
          ft.attachment,
          "".concat(ft.attachment, "--").concat(this.attachment.getType()),
        ],
...
`);
    ...
    createElement() {
      ...
      if (Object.keys(r).length)
        for (e in (t || (t = p("span")), r)) (n = r[e]), (t.style[e] = n);
      return t;
    }
    createContainerElement() {
  ...
  He = class extends gt {
    ...
    createNodes() {
      ...
      for (let o = 0; o < e.length; o++) {
        ...
        let c = this.findOrCreateCachedChildView(qe, s, {
...
function x(i, t) {
  return ds(i, Hr(i, t, "get"));
}
function Ci(i, t, e) {
  return gs(i, Hr(i, t, "set"), e), e;
}
function Hr(i, t, e) {
  if (!t.has(i))
...
var Ke = class extends Jt {
  ...
  yt = class extends dt {
    ...
    getExtension() {
      var t;
      return (t = this.getFilename().match(/\.(\w+)$/)) === null || t === void 0
        ? void 0
        : t[1].toLowerCase();
    }
    getContentType() {
...
q(yt, "previewablePattern", /^image(\/(gif|png|webp|jpe?g)|$)/);
...
q(xt, "permittedAttributes", ["caption", "presentation"]),
...
` && this.getAttribute("blockBreak") === !0
  ...
  canBeConsolidatedWith(t) {
    return (
      t && this.hasSameConstructorAs(t) && this.hasSameAttributesAsPiece(t)
    );
  }
  consolidateWith(t) {
...
var $t = class extends dt {
    ...
    splitObjectsAtRange(t) {
      ...
      return (
        ([n, e] = new this.constructor(n).splitObjectAtPosition(fs(t) + o)),
        [n, r, e - 1]
      );
    }
    ...
    getEndPosition() {
      return (
        this.endPosition == null &&
          ((this.endPosition = 0),
          this.objects.forEach((t) => (this.endPosition += t.getLength()))),
        this.endPosition
      );
    }
    toString() {
  ...
  K = class extends dt {
    ...
    getAttributesAtPosition(t) {
      var e;
      return (
        ((e = this.pieceList.getObjectAtPosition(t)) === null || e === void 0
          ? void 0
          : e.getAttributes()) || {}
      );
    }
  ...
  $ = class extends dt {
    ...
    copyWithText(t) {
      return new $(t, this.attributes, this.htmlAttributes);
    }
    copyWithoutText() {
      return this.copyWithText(null);
    }
    copyWithAttributes(t) {
      return new $(this.text, t, this.htmlAttributes);
    }
    ...
    addHTMLAttribute(t, e) {
      ...
      return new $(this.text, this.attributes, n);
    }
    removeAttribute(t) {
...
`),
  ...
  As = K.textForStringWithAttributes(
    `
`,
    { blockBreak: !0 },
  ),
  ...
  z = class extends dt {
    static fromJSON(t) {
      return new this(Array.from(t).map((e) => $.fromJSON(e)));
    }
    static fromString(t, e) {
      let n = K.textForStringWithAttributes(t, e);
      return new this([new $(n)]);
    }
    constructor() {
      let t =
        arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
    ...
    mergeDocumentAtRange(t, e) {
      ...
      if (Ft(c, u)) {
        ...
        n = t.copy({ consolidateBlocks: !0 }).copyWithBaseBlockAttributes(l);
...
`
        ...
        H =
          l !== d && c === 0 && u.getAttributeLevel() >= T.getAttributeLevel()
            ...
            : u.copyWithText(pt);
        let Ct = d + 1 - l;
        e = this.blockList.splice(l, Ct, H);
      }
      return new this.constructor(e);
    }
    moveTextFromRangeToPosition(t, e) {
    ...
    addAttribute(t, e) {
      ...
      return (
        this.eachBlock(
          (r, o) => (n = n.editObjectAtIndex(o, () => r.addAttribute(t, e))),
        ),
    ...
    removeBlockAttributesAtRange(t) {
      ...
      return (
        this.eachBlockAtRange(t, function (n, r, o) {
          n.hasAttributes() &&
            (e = e.editObjectAtIndex(o, () => n.copyWithoutAttributes()));
        }),
        new this.constructor(e)
      );
    }
      ...
      if (ht(t)) return this.getCommonAttributesAtPosition(e);
      {
        ...
        return (
          this.eachBlockAtRange(t, function (o, s) {
            if (s[0] !== s[1])
              return (
                n.push(o.text.getCommonAttributesAtRange(s)), r.push(yr(o))
              );
          }),
...
`,
        ...
        case "tr":
          if (this.needsTableSeparator(t))
            return this.appendStringWithAttributes(Me.tableRowSeparator);
          break;
        case "td":
          if (this.needsTableSeparator(t))
            return this.appendStringWithAttributes(Me.tableCellSeparator);
      }
    }
    ...
    getTextAttributes(t) {
      ...
      for (let r in It) {
        ...
        if (
          ...
          o.styleProperty && ((e = t.style[o.styleProperty]), e && (n[r] = e));
      }
      if (Lt(t)) {
    ...
    isBlockElement(t) {
      if (
        ...
        return (
          de().includes(j(t)) || window.getComputedStyle(t).display === "block"
        );
    }
...
`,
  ...
  Er = function (i) {
    let t = window.getComputedStyle(i);
    if (t.display === "block")
      return { top: parseInt(t.marginTop), bottom: parseInt(t.marginBottom) };
  },
  Es = function (i) {
    return j(i) === "style"
  ...
  Ls = {
    ...
    "text/html": function (i) {
      ...
      return (
        Array.from(t.querySelectorAll("[data-trix-serialize=false]")).forEach(
          (e) => {
            At(e);
          },
        ),
  ...
  rt = class extends R {
    ...
    insertText(t) {
      ...
      let r = n[0],
        o = r + t.getLength();
      return (
        e && this.setSelection(o), this.notifyDelegateOfInsertionAtRange([r, o])
      );
    }
    insertBlock() {
      let t =
...
`);
    ...
    removeLastBlockAttribute() {
      ...
      return (
        this.removeCurrentAttribute(n.getLastAttribute()), this.setSelection(t)
      );
    }
    insertPlaceholder() {
      return (
        (this.placeholderPosition = this.getPosition()), this.insertString(" ")
      );
    }
    selectPlaceholder() {
    ...
    setBlockAttribute(t, e) {
      ...
      if (this.canSetCurrentAttribute(t))
        return (
          this.setDocument(this.document.applyBlockAttributeAtRange(t, e, n)),
          this.setSelection(n)
        );
    }
    ...
    positionIsBlockBreak(t) {
      var e;
      return (e = this.document.getPieceAtPosition(t)) === null || e === void 0
        ? void 0
        : e.isBlockBreak();
    }
    getSelectedDocument() {
...
`
      ...
      return (
        this.setDocument(e.insertDocumentAtRange(s, o)), this.setSelection(r)
      );
    }
    getPreviousBlock() {
      let t = this.getLocationRange();
...
var Ae = class extends R {
    ...
    undo() {
      ...
      if (t) {
        ...
        return (
          this.redoEntries.push(e), this.composition.loadSnapshot(t.snapshot)
        );
      }
    }
    redo() {
      ...
      if (t) {
        let e = this.createEntry(t);
        return (
          this.undoEntries.push(e), this.composition.loadSnapshot(t.snapshot)
        );
      }
    }
    canUndo() {
  ...
  Ye = class {
    ...
    removeBlockAttribute() {
      return this.findRangesOfBlocks().map(
        (t) => (this.document = this.document.removeAttributeAtRange(Wn, t)),
      );
    }
    applyBlockAttribute() {
      let t = 0;
...
` &&
  ...
  Ze = class {
      ...
      if (r) {
        if (ge(r))
          ...
          if (((e = r.parentNode), !Yi(r.previousSibling) && !Rn(e)))
            for (
              ;
              r === e.lastChild && ((r = e), (e = e.parentNode), !Rn(e));
    ...
    findNodeAndOffsetFromLocation(t) {
      ...
      for (let o of this.getSignificantNodesForIndex(t.index)) {
        ...
        if (t.offset <= r + s)
          if (ge(o)) {
            if (((e = o), (n = r), t.offset === n && Ht(e))) break;
          } else e || ((e = o), (n = r));
  ...
  Qe = class {
    createDOMRangeFromPoint(t) {
      ...
      if (document.caretPositionFromPoint) {
        let { offsetNode: o, offset: s } = document.caretPositionFromPoint(
          n,
          r,
        );
  ...
  ut = class extends R {
    ...
    selectionIsCollapsed() {
      var t;
      return (
        ((t = me()) === null || t === void 0 ? void 0 : t.collapsed) === !0
      );
    }
    selectionIsExpanded() {
            ...
            return {
              do: () => {
                if (
                  ...
                  u.appendChild(o),
                  u.appendChild(s),
                  u.classList.add("".concat(kt.attachmentCaption, "--editing")),
  ...
  ci = class {
    ...
    insertingLongTextAfterUnidentifiedChar() {
      ...
      return (
        ...
        ((t = this.event.data) === null || t === void 0 ? void 0 : t.length) >
          50
      );
    }
    ...
    previousEventWasUnidentifiedKeydown() {
      ...
      return (
        ((t = this.previousEvent) === null || t === void 0
          ? void 0
          : t.type) === "keydown" &&
        ((e = this.previousEvent) === null || e === void 0 ? void 0 : e.key) ===
          "Unidentified"
      );
    }
  },
  ...
  Yt = class extends R {
    constructor(t) {
      ...
      for (let e in this.constructor.events)
        S(e, { onElement: this.element, withCallback: this.handlerFor(e) });
    }
    elementDidMutate(t) {}
...
q(Z, "events", {
  ...
  drop(i) {
    ...
    if (
      ...
      (c = this.responder) === null || c === void 0 || c.insertDocument(u),
        this.requestRender();
    }
...
`),
      ...
      left(i) {
        if (this.selectionIsInCursorTarget())
          return (
            i.preventDefault(), this.expandSelectionInDirection("backward")
          );
      },
      right(i) {
        if (this.selectionIsInCursorTarget())
  ...
  Z.proxyMethod("responder?.getSelectedRange"),
  Z.proxyMethod("responder?.setSelectedRange"),
  Z.proxyMethod("responder?.expandSelectionInDirection"),
  Z.proxyMethod("responder?.selectionIsInCursorTarget"),
  Z.proxyMethod("responder?.selectionIsExpanded");
var zs = (i) => {
    var t;
  ...
  qs = !((qn = " ".codePointAt) === null || qn === void 0 || !qn.call(" ", 0)),
  Hs = function (i) {
    if (i.key && qs && i.key.codePointAt(0) === i.keyCode) return i.key;
    {
      let t;
      if (
        (i.which === null
  ...
  it = class extends R {
    ...
    canApplyToDocument() {
      var t, e;
      return (
        ((t = this.data.start) === null || t === void 0 ? void 0 : t.length) ===
          0 &&
...
var Ks = function (i) {
  ...
  Ys = function (i) {
    let t = [];
    return (
      i.altKey && t.push("alt"), i.shiftKey && t.push("shift"), t.push(i.key), t
    );
  },
  ...
  sn = class extends R {
    ...
    didClickActionButton(t, e) {
      var n;
      (n = this.delegate) === null || n === void 0 || n.toolbarDidClickButton(),
        t.preventDefault();
      let r = Tr(e);
    ...
    setAttribute(t) {
      ...
      return !r.willValidate ||
        (r.setCustomValidity(""), r.checkValidity() && this.isSafeAttribute(r))
        ? ((e = this.delegate) === null ||
            e === void 0 ||
    ...
    constructor(t) {
      pe(this, Kn, { writable: !0, value: void 0 }),
        pe(this, Gn, {
          ...
          value: (e) => {
            e.defaultPrevented ||
              (e.target === this.element.form && this.element.reset());
          },
        }),
        pe(this, $n, {
          writable: !0,
...
q(ye, "formAssociated", "ElementInternals" in window);
var Q = {
  VERSION: po,
  config: Ce,
  core: Ds,
...
Q.config.blockAttributes.default.tagName = "p";
Q.config.blockAttributes.default.breakOnReturn = !0;
Q.config.blockAttributes.heading = {
  tagName: "h2",
  terminal: !0,
  breakOnReturn: !0,
  group: !1,
};
Q.config.blockAttributes.subHeading = {
  tagName: "h3",
  terminal: !0,
  breakOnReturn: !0,
  group: !1,
};
Q.config.textAttributes.underline = {
  style: { textDecoration: "underline" },
  inheritable: !0,
  parser: (i) =>
    window.getComputedStyle(i).textDecoration.includes("underline"),
};
Q.Block.prototype.breaksOnReturn = function () {
  let i = this.getLastAttribute();
  return Q.config.blockAttributes[i || "default"]?.breakOnReturn ?? !1;
};
Q.LineBreakInsertion.prototype.shouldInsertBlockBreak = function () {
  return this.block.hasAttributes() &&
    this.block.isListItem() &&
    !this.block.isEmpty()
    ? this.startLocation.offset > 0
