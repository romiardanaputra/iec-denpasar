    ...
    return (function () {
      ...
      var se = {
                ...
                return (
                  ...
                  (g.prototype._renderChoices = function () {
                    ...
                    if (
                      ...
                      s.length >= 1 && (v = this._createChoicesFragment(s, v));
                    ...
                    var v = function (P) {
                      return t.filter(function (M) {
                        return s._isSelectOneElement
                          ? M.groupId === P.id
                          : M.groupId === P.id &&
                              (s.config.renderSelectedChoices === "always" ||
                                !M.selected);
                      });
                    };
                    return (
                  ...
                  (g.prototype._handleChoiceAction = function (e, t) {
                    if (!(!e || !t)) {
                      ...
                      if (s) {
                        ...
                        if (
                          ((s.keyCode = v),
                          this.passedElement.triggerEvent(y.EVENTS.choice, {
                            choice: s,
                          }),
                  ...
                  (g.prototype._onEnterKey = function (e, t, n) {
                    ...
                    if (
                      (P &&
                        (this._handleButtonAction(t, s), e.preventDefault()),
                      n)
                    ) {
                  ...
                  (g.prototype._addGroup = function (e) {
                    ...
                    if (f) {
                      ...
                      var Y = function (V) {
                        var U =
                          V.disabled || (V.parentNode && V.parentNode.disabled);
                        t._addChoice({
                          value: V[P],
                  ...
                  (d.prototype.scrollToChildElement = function (a, r) {
                    ...
                    if (a) {
                      var l = this.element.offsetHeight,
                        ...
                        y = a.offsetTop + L,
                        D =
                          r > 0 ? this.element.scrollTop + y - O : a.offsetTop;
                      requestAnimationFrame(function () {
          ...
          221: function (j, i, b) {
            ...
            function l(p) {
              return (
                p === !0 || p === !1 || (L(p) && k(p) == "[object Boolean]")
              );
            }
            function O(p) {
            ...
            let Ce = { AND: "$and", OR: "$or" },
              ...
              it = (p) => !_(p) && O(p) && !Re(p),
              ke = (p) => ({
                [Ce.AND]: Object.keys(p).map((o) => ({ [o]: p[o] })),
              });
          ...
          791: function (j, i, b) {
            ...
            function n(f) {
              ...
              return function (z, ee) {
                ...
                return (
                  (ce = ce || U.length !== Object.keys(z).length), ce ? le : z
                );
              };
            }
            function s(f, u) {
