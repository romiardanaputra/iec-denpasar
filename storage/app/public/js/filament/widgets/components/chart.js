        ...
        ? (r =
            it(
              Math.max(
                ...
                e ? 0 : Ft(t, l, o.getPixelForValue(h), !0).hi + 1,
              ),
              n,
              i,
            ) - n)
...
var bi = (s) => s === 0 || s === 1,
  po = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * B) / e)),
...
function qc(s, t) {
  var e = Hn(s);
  (e[0] = Bo(e[0] + t)), (e = $n(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]);
}
function Gc(s) {
  if (!s) return;
  let t = Hn(s),
...
function _s(s, t, e, i, n) {
  let r = t[n];
  return (
    r || ((r = t[n] = s.measureText(n).width), e.push(n)), r > i && (i = r), i
  );
}
function Yo(s, t, e, i) {
  i = i || {};
...
function yh(s, t, e, i) {
  let n;
  for (let r of t)
    if (((n = Jo(hh(r, s), e)), ft(n))) return Gn(s, n) ? Xn(e, i, s, n) : n;
}
function Jo(s, t) {
  for (let e of t) {
    if (!e) continue;
...
function bh(s) {
  let t = new Set();
  for (let e of s)
    for (let i of Object.keys(e).filter((n) => !n.startsWith("_"))) t.add(i);
  return Array.from(t);
}
function Kn(s, t, e, i) {
  let { iScale: n } = s,
...
function ta(s, t, e, i, n) {
  ...
  if (
    ...
    for (r = 0, o = s.length; r < o; ++r)
      (a = s[r]),
        (l = _h(c, a, s[Math.min(r + 1, o - (i ? 0 : 1)) % o], t.tension)),
        (a.cp1x = l.previous.x),
        (a.cp1y = l.previous.y),
        (a.cp2x = l.next.x),
        (a.cp2y = l.next.y),
...
function Ah(s, t, e) {
  let { property: i, start: n, end: r } = e,
    ...
    f;
  if (u) {
    for (c += l, h += l, d = 0, f = l; d < f && o(a(t[c % l][i]), n, r); ++d)
      c--, h--;
    (c %= l), (h %= l);
  }
    ...
    (b = t[O % o]),
      !b.skip &&
        ...
        y !== _ &&
          ...
          p !== null &&
            k() &&
            (m.push(To({ start: p, end: O, loop: d, count: o, style: f })),
            (p = null)),
          (v = O),
          (_ = y)));
  return (
    p !== null && m.push(To({ start: p, end: u, loop: d, count: o, style: f })),
    m
  );
}
function nr(s, t) {
...
function $h(s, t) {
  ...
  return (
    e.$shared &&
      (s.options = e = Object.assign({}, e, { $shared: !1, $animations: {} })),
    e
  );
}
function la(s, t) {
  ...
  pt = class {
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        (e._clip = Uh(
          C(this.options.clip, jh(e.xScale, e.yScale, this.getMaxOverflow())),
        ));
    }
    update(t) {}
    draw() {
    ...
    updateElement(t, e, i, n) {
      or(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
    }
...
var $e = class extends pt {
  ...
  updateElements(t, e, i, n) {
    ...
    for (let f = e; f < e + i; f++) {
      ...
      d &&
        (b.options =
          u || this.resolveDataElementOptions(f, t[f].active ? "active" : n));
...
var je = class extends pt {
  ...
  parseArrayData(t, e, i, n) {
    ...
    for (let o = 0; o < r.length; o++) {
      let a = e[i + o];
      r[o]._custom = C(a[2], this.resolveDataElementOptions(o + i).radius);
    }
    return r;
  }
  parseObjectData(t, e, i, n) {
  ...
  updateElements(t, e, i, n) {
    ...
    for (let d = e; d < e + i; d++) {
      ...
      (g.skip = isNaN(p) || isNaN(y)),
        c &&
          ((g.options =
            l || this.resolveDataElementOptions(d, f.active ? "active" : n)),
  ...
  resolveDataElementOptions(t, e) {
    ...
    let r = n.radius;
    return (
      e !== "active" && (n.radius = 0), (n.radius += C(i && i._custom, r)), n
    );
  }
};
je.id = "bubble";
...
var oe = class extends pt {
  ...
  updateElements(t, e, i, n) {
    ...
    for (b = e; b < e + i; ++b) {
      ...
      p &&
        (x.options =
          g || this.resolveDataElementOptions(b, w.active ? "active" : n)),
        (y += _),
  ...
  updateElements(t, e, i, n) {
    ...
    for (let _ = e; _ < e + i; ++_) {
      ...
      (S.skip = isNaN(O) || isNaN(v) || k),
        ...
        u &&
          (S.options =
            h || this.resolveDataElementOptions(_, w.active ? "active" : n)),
...
var tl = {
  ...
  logarithmic(s, t, e) {
    ...
    return i === 1 || i === 2 || i === 5 ? tl.numeric.call(this, s, t, e) : "";
  },
};
function hu(s, t) {
...
function Ni(s, t, e, i, n) {
  let r = C(i, 0),
    ...
    h;
  for (
    e = Math.ceil(e), n && ((l = n - i), (e = l / Math.floor(l / e))), h = r;
    h < 0;
...
function ku(s, t, e, i) {
  ...
  if (s.isHorizontal()) {
    if (((f = ot(i, r, a)), A(e))) {
      ...
      e === "center" ? (m = (c.bottom + c.top) / 2 + g - t) : (m = ya(s, e, t));
    d = a - r;
  } else {
    if (A(e)) {
      let y = Object.keys(e)[0],
      ...
      e === "center" ? (f = (c.left + c.right) / 2 - p + t) : (f = ya(s, e, t));
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          for (h = 0, u = d.length; h < u; ++h)
            (_ = d[h]),
              !N(_) && !$(_) && ((y = _s(i, g.data, g.gc, y, _)), (b += p));
...
function Ku(s) {
  return !Jn() || (typeof OffscreenCanvas < "u" && s instanceof OffscreenCanvas)
    ? yr
    : br;
}
var xr = class {
...
function _r(s, t) {
  let e = L.datasets[s] || {};
  return (
    ((t.datasets || {})[s] || {}).indexAxis || t.indexAxis || e.indexAxis || "x"
  );
}
function sd(s, t) {
  let e = s;
  return (
    s === "_index_" ? (e = t) : s === "_value_" && (e = t === "x" ? "y" : "x"),
    e
  );
}
function id(s, t) {
      ...
      e &&
        ...
        H(r, (o) => {
          let a = o.options,
            ...
            c = wr(l, a),
            h = C(a.type, o.dtype);
          (a.position === void 0 || Da(a.position, c) !== Da(o.dposition)) &&
...
function yd(s, t, e) {
  let { x: i, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
    ...
    h;
  for (
    e && hl(s, t, r + B), s.beginPath(), s.arc(i, n, c, r + B, r, !0), h = 0;
    h < a;
    ++h
  )
    s.stroke();
...
function Ld(s, t, e, i, n) {
  ...
  for (o[l++] = s[h], u = 0; u < r - 2; u++) {
    ...
    let S = Math.floor(u * a) + 1 + t,
      ...
      { x: O, y: v } = s[h];
    for (f = m = -1, b = S; b < k; b++)
      (m = 0.5 * Math.abs((O - p) * (s[b].y - v) - (O - s[b].x) * (y - v))),
        m > f && ((f = m), (d = s[b]), (g = b));
    (o[l++] = d), (h = g);
  }
  return (o[l++] = s[c]), o;
...
function gl(s, t) {
  ...
  return (
    $(s) ? ((i = !0), (e = s)) : (e = zd(s, t)),
    e.length
      ? new Nt({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i })
      : null
  );
}
function Pa(s) {
...
var nf = {
    ...
    afterDatasetsUpdate(s, t, e) {
      ...
      for (o = 0; o < i; ++o)
        (r = s.getDatasetMeta(o)),
          ...
          n.push(l);
      for (o = 0; o < i; ++o)
        (l = n[o]), !(!l || l.fill === !1) && (l.fill = Vd(n, o, e.propagate));
    },
    beforeDraw(s, t, e) {
    ...
    beforeDatasetDraw(s, t, e) {
      let i = t.meta.$filler;
      !Pa(i) || e.drawTime !== "beforeDatasetDraw" || fr(s.ctx, i, s.chartArea);
    },
        ...
        l.setWidth(this.width),
          w
            ...
            : O > 0 &&
              ...
              m.line++,
              (tt = m.y =
                ot(r, this.top + x + u, this.bottom - e[m.line].height)));
        let ct = l.x(R);
        b(ct, tt, k),
...
function ff(s, t, e, i) {
  ...
  if ((s === "left" && n + r + o > t.width) || (s === "right" && n - r - o < 0))
    return !0;
}
function mf(s, t, e, i) {
  let { x: n, width: r } = e,
...
var Rs = class extends yt {
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = yf(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    let { callbacks: i } = e,
  ...
  _updateAnimationTarget(t) {
    let e = this.chart,
      ...
      r = i && i.y;
    if (n || r) {
      let o = Is[t.position].call(this, this._active, this._eventPosition);
      if (!o) return;
...
var Sf = (s, t) => (s === null ? null : it(Math.round(s), 0, t)),
  Je = class extends Yt {
    ...
    parse(t, e) {
      ...
      return (
        (e =
          isFinite(e) && i[e] === t ? e : wf(i, t, C(e, t), this._addedLabels)),
        Sf(e, i.length - 1)
      );
    }
    determineDataLimits() {
...
function Tf(s, t, e) {
  return (
    (e = $(e) ? e : [e]), { w: Yo(s, t.string, e), h: e.length * t.lineHeight }
  );
}
...
var we = class extends Yt {
  ...
  buildTicks() {
    ...
    return (
      ...
      (this._majorUnit =
        !i.major.enabled || this._unit === "year" ? void 0 : Nf(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
...
function Bi(s, t, e) {
  let i = 0,
    ...
    l;
  e
    ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = Ft(s, "pos", t)),
      ({ pos: r, time: a } = s[i]),
      ({ pos: o, time: l } = s[n]))
    : (t >= s[i].time &&
        t <= s[n].time &&
...
function Qf(s) {
  return s.numberingSystem && s.numberingSystem !== "latn"
    ...
    : s.numberingSystem === "latn" ||
        ...
        new Intl.DateTimeFormat(s.intl).resolvedOptions().numberingSystem ===
          "latn";
}
var Rr = class {
    constructor(t, e, i) {
  ...
  P = class {
      ...
      return on(this, t, zr, () => {
        ...
        return (
          this.monthsCache[n][t] ||
            (this.monthsCache[n][t] = Kf((r) => this.extract(r, i, "month"))),
          this.monthsCache[n][t]
        );
      });
    }
    ...
    eras(t) {
      return on(this, t, Br, () => {
        ...
        return (
          this.eraCache[t] ||
            (this.eraCache[t] = [T.utc(-40, 1, 1), T.utc(2017, 1, 1)].map((i) =>
...
var U = class {
  ...
  toString() {
    return this.isValid ? `[${this.s.toISO()} \u2013 ${this.e.toISO()})` : fs;
  }
  [Symbol.for("nodejs.util.inspect.custom")]() {
    return this.isValid
  ...
  toISODate() {
    return this.isValid ? `${this.s.toISODate()}/${this.e.toISODate()}` : fs;
  }
  toISOTime(t) {
    return this.isValid ? `${this.s.toISOTime(t)}/${this.e.toISOTime(t)}` : fs;
  }
  toFormat(t, { separator: e = " \u2013 " } = {}) {
    return this.isValid ? `${this.s.toFormat(t)}${e}${this.e.toFormat(t)}` : fs;
  }
  toDuration(t, e) {
    return this.isValid
...
function yc(s, t, e) {
  let { result: i, zone: n, specificOffset: r, invalidReason: o } = ao(s, t, e);
  return [i, n, r, o];
}
function lo(s, t) {
  if (!s) return null;
...
function hg(s) {
  return (
    yn[s] || (pn === void 0 && (pn = z.now()), (yn[s] = s.offset(pn))), yn[s]
  );
}
function Sc(s, t) {
  ...
  T = class {
    ...
    static fromFormat(t, e, i = {}) {
      ...
      let { locale: n = null, numberingSystem: r = null } = i,
        o = P.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 }),
        [a, l, c, h] = yc(o, t, e);
    ...
    static invalid(t, e = null) {
      if (!t) throw new J("need to specify a reason the DateTime is invalid");
      let i = t instanceof rt ? t : new rt(t, e);
    ...
    toRelative(t = {}) {
      ...
      return (
        ...
        kc(e, this.plus(i), { ...t, numeric: "always", units: n, unit: r })
      );
    }
    ...
    static buildFormatParser(t, e = {}) {
      let { locale: i = null, numberingSystem: n = null } = e,
        r = P.fromOpts({ locale: i, numberingSystem: n, defaultToEN: !0 });
      return new gi(r, t);
    }
    ...
    return s === null || i === "undefined"
      ...
      : (i === "number"
          ...
          : i === "string"
            ...
            : s instanceof Date
              ? (s = T.fromJSDate(s, e))
              : i === "object" && !(s instanceof T) && (s = T.fromObject(s, e)),
  ...
  return {
    ...
    initChart: function (i = null) {
      ...
      (Wt.defaults.borderColor = n),
        ...
        (Wt.defaults.font.family = getComputedStyle(this.$el).fontFamily),
