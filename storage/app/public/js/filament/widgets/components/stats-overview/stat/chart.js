...
var at = (i, t, e, s) => qe(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e),
  qs = (i, t, e) => qe(i, e, (s) => i[s][t] >= e);
function Gs(i, t, e) {
  let s = 0,
    n = i.length;
  for (; s < n && i[s] < t; ) s++;
...
var Ge = (i) => (i === "start" ? "left" : i === "end" ? "right" : "center"),
...
var Be = (i) => i === 0 || i === 1,
  ...
  Ht = {
    ...
    easeInElastic: (i) => (Be(i) ? i : As(i, 0.075, 0.3)),
    easeOutElastic: (i) => (Be(i) ? i : Ts(i, 0.075, 0.3)),
    easeInOutElastic(i) {
      return Be(i)
        ? i
        : i < 0.5
...
var st = {
  ...
  Pi = [..."0123456789ABCDEF"],
  No = (i) => Pi[i & 15],
  Ho = (i) => Pi[(i & 240) >> 4] + Pi[i & 15],
  Ve = (i) => (i & 240) >> 4 === (i & 15),
  jo = (i) => Ve(i.r) && Ve(i.g) && Ve(i.b) && Ve(i.a);
function $o(i) {
  var t = i.length,
    e;
  return (
...
var We;
function sa(i) {
  We || ((We = ia()), (We.transparent = [0, 0, 0, 0]));
  let t = We[i.toLowerCase()];
...
function ra(i, t, e) {
  let s = Nt(ut(i.r)),
    ...
    o = Nt(ut(i.b));
  return {
    r: vt(Mi(s + e * (Nt(ut(t.r)) - s))),
    g: vt(Mi(n + e * (Nt(ut(t.g)) - n))),
    b: vt(Mi(o + e * (Nt(ut(t.b)) - o))),
    a: i.a + e * (t.a - i.a),
  };
}
function Ne(i, t, e) {
...
var Ci = class {
    constructor(t) {
      (this.animation = void 0),
        ...
        (this.hover = {}),
        (this.hoverBackgroundColor = (e, s) => wi(s.backgroundColor)),
        (this.hoverBorderColor = (e, s) => wi(s.borderColor)),
        (this.hoverColor = (e, s) => wi(s.color)),
        (this.indexAxis = "x"),
        (this.interaction = {
          mode: "nearest",
          intersect: !0,
...
function Xi(i) {
  return Qe(i, { top: "y", right: "x", bottom: "y", left: "x" });
}
function St(i) {
  return Qe(i, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
}
function U(i) {
  let t = Xi(i);
  ...
  for (e = 0, s = i.length; e < s; ++e)
    (a = o),
      ...
      o &&
        ((n = i[e]),
        a &&
          ((n.cp1x = He(n.cp1x, t.left, t.right)),
          (n.cp1y = He(n.cp1y, t.top, t.bottom))),
        r &&
          ((n.cp2x = He(n.cp2x, t.left, t.right)),
          (n.cp2y = He(n.cp2y, t.top, t.bottom))));
}
...
var ii = (i) => window.getComputedStyle(i, null);
function Ta(i, t) {
  return ii(i).getPropertyValue(t);
}
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) (t = i.clientWidth), (e = i.clientHeight);
      ...
      (t = a.width - c.width - l.width),
        ...
        (s = Xe(r.maxWidth, o, "clientWidth")),
        (n = Xe(r.maxHeight, o, "clientHeight"));
    }
  }
  return { width: t, height: e, maxWidth: s || $e, maxHeight: n || $e };
}
var Si = (i) => Math.round(i * 10) / 10;
function mn(i, t, e, s) {
  let n = ii(i),
    o = Tt(n, "margin"),
    a = Xe(n.maxWidth, i, "clientWidth") || $e,
    r = Xe(n.maxHeight, i, "clientHeight") || $e,
    l = Fa(i, t, e),
    { width: c, height: h } = l;
  ...
  return (
    ...
    (c = Si(Math.min(c, a, l.maxWidth))),
    (h = Si(Math.min(h, r, l.maxHeight))),
    c && !h && (h = Si(c / 2)),
    { width: c, height: h }
  );
}
    ...
    (_ = t[S % a]),
      !_.skip &&
        ...
        b !== v &&
          ...
          m !== null &&
            w() &&
            (g.push(Vs({ start: m, end: S, loop: u, count: a, style: f })),
            (m = null)),
          (k = S),
          (v = b)));
  return (
    m !== null && g.push(Vs({ start: m, end: d, loop: u, count: a, style: f })),
    g
  );
}
function ss(i, t) {
...
var os = (i) => i === "reset" || i === "none",
  ...
  et = class {
    ...
    _destroy() {
      let t = this._cachedMeta;
      this._data && Ei(this._data, this), t._stacked && ve(t);
    }
    _dataCheck() {
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        (e._clip = Za(
          C(this.options.clip, Ga(e.xScale, e.yScale, this.getMaxOverflow())),
        ));
    }
    update(t) {}
    draw() {
    ...
    _resolveElementOptions(t, e = "default", s) {
      ...
      return (
        p.$shared && ((p.$shared = l), (o[a] = Object.freeze(Dn(p, l)))), p
      );
    }
...
var Ot = class extends et {
  ...
  updateElements(t, e, s, n) {
    ...
    for (_ = e; _ < e + s; ++_) {
      ...
      m &&
        (x.options =
          p || this.resolveDataElementOptions(_, y.active ? "active" : n)),
        (b += v),
...
function br(i, t) {
  ...
  if (o > 0) {
    ...
    for (si(t, l, c, T(u) ? 0 : a - u, a), h = 0, d = o - 1; h < d; h++)
      si(t, l, c, n[h], n[h + 1]);
    return si(t, l, c, r, T(u) ? t.length : r + u), l;
  }
  return si(t, l, c), l;
}
function _r(i) {
...
function Or(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    if (((f = X(s, o, r)), D(e))) {
      ...
      e === "center" ? (g = (c.bottom + c.top) / 2 + p - t) : (g = Ln(i, e, t));
    u = r - o;
  } else {
    if (D(e)) {
      let b = Object.keys(e)[0],
      ...
      e === "center" ? (f = (c.left + c.right) / 2 - m + t) : (f = Ln(i, e, t));
...
var _t = class extends it {
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          for (h = 0, d = u.length; h < d; ++h)
            (v = u[h]),
              !T(v) && !I(v) && ((b = me(s, p.data, p.gc, b, v)), (_ += m));
    ...
    getContext(t) {
      ...
      return (
        this.$context || (this.$context = Pr(this.chart.getContext(), this))
      );
    }
    _tickSize() {
...
function Bn(i, t, e, s) {
  ...
  for (let r of i) {
    ...
    if (r.horizontal) {
      ...
      J(c.start) && (a = c.start),
        l.fullSize
          ? ni(l, n.left, a, e.outerWidth - n.right - n.left, u)
          : ni(l, t.left + c.placed, a, d, u),
        (c.start = a),
        (c.placed += d),
        (a = l.bottom);
    } else {
      ...
      J(c.start) && (o = c.start),
        l.fullSize
          ? ni(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
          : ni(l, o, t.top + c.placed, u, d),
        (c.start = o),
        (c.placed += d),
        (o = l.right);
    }
...
function Jr(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1;
      for (let r of o)
        (a = a || ui(r.addedNodes, s)), (a = a && !ui(r.removedNodes, s));
      a && e();
    });
...
function Qr(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1;
      for (let r of o)
        (a = a || ui(r.removedNodes, s)), (a = a && !ui(r.addedNodes, s));
      a && e();
    });
  return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
function nl(i) {
  return !Zi() || (typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas)
    ? ms
    : bs;
}
var _s = class {
  ...
  return (
    Object.keys(s).forEach((r) => {
      ...
      let c = ys(r, l),
        ...
        d = e.scales || {};
      (o[c] = o[c] || r),
        (a[r] = Ut(Object.create(null), [{ axis: c }, l, d[c], d[h]]));
    }),
...
var Se = (i, t, e) => {
  ...
  vs = class {
    ...
    chartOptionScopes() {
      ...
      return [t, Mt[e] || {}, O.datasets[e] || {}, { type: e }, O, Ze];
    }
...
Object.defineProperties(It, {
  ...
  instances: { enumerable: Ct, value: fi },
...
function vl(i) {
  return Qe(i, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
}
function Ml(i, t, e, s) {
...
function kl(i, t, e) {
  let { x: s, y: n, startAngle: o, pixelMargin: a, fullCircles: r } = t,
    ...
    h;
  for (
    e && Po(i, t, o + F), i.beginPath(), i.arc(s, n, c, o + F, o, !0), h = 0;
    h < r;
    ++h
  )
    i.stroke();
...
function ks(i, t, e, s) {
  ...
  let n = t[i],
    o = e[i];
  return (
    i === "angle" && ((n = G(n)), (o = G(o))), { property: i, start: n, end: o }
  );
}
function Xl(i, t) {
...
function To(i, t) {
  ...
  return (
    ...
    e.length
      ? new dt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  );
}
function Gn(i) {
...
function sc(i) {
  ...
  if (e === "shape") return !0;
  let n = oc(i);
  return n instanceof gi ? n : To(n, s);
}
function nc(i, t) {
        ...
        l.setWidth(this.width),
          y
            ...
            : S > 0 &&
              ...
              g.line++,
              (H = g.y =
                X(o, this.top + x + d, this.bottom - e[g.line].height)));
        let q = l.x(A);
        _(q, H, w),
...
var pc = {
  ...
  mc = {
    ...
    start(i, t, e) {
      ...
      K.configure(i, s, e), K.addBox(i, s), ai.set(i, s);
    },
    stop(i) {
      K.removeBox(i, ai.get(i)), ai.delete(i);
    },
    beforeUpdate(i, t, e) {
      let s = ai.get(i);
      K.configure(i, s, e), (s.options = e);
...
var Le = class extends it {
  ...
  _resolveAnimations() {
    ...
    let e = this.chart,
      ...
      o = new hi(this.chart, n);
    return n._cacheable && (this._cachedAnimations = Object.freeze(o)), o;
  }
  getContext() {
    return (
      this.$context ||
      (this.$context = wc(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    let { callbacks: s } = e,
...
var Dc = (i, t) => (i === null ? null : Y(Math.round(i), 0, t)),
  he = class extends _t {
    ...
    parse(t, e) {
      ...
      return (
        (e =
          isFinite(e) && s[e] === t ? e : Cc(s, t, C(e, t), this._addedLabels)),
        Dc(e, s.length - 1)
      );
    }
    determineDataLimits() {
...
Re.id = "linear";
Re.defaults = { ticks: { callback: mi.formatters.numeric } };
function ro(i) {
...
var Ee = class extends _t {
  ...
  getLabelForValue(t) {
    return t === void 0
      ? "0"
      : Jt(t, this.chart.options.locale, this.options.ticks.format);
  }
  configure() {
    let t = this.min;
    super.configure(),
...
Ee.id = "logarithmic";
Ee.defaults = {
  ticks: { callback: mi.formatters.logarithmic, major: { enabled: !0 } },
};
function Ss(i) {
  let t = i.ticks;
...
function Tc(i, t, e) {
  return (
    (e = I(e) ? e : [e]), { w: rn(i, t.string, e), h: e.length * t.lineHeight }
  );
}
...
function Hc(i, t, e, s, n) {
  for (let o = Z.length - 1; o >= Z.indexOf(e); o--) {
    let a = Z[o];
    if (bi[a].common && i._adapter.diff(n, s, a) >= t - 1) return a;
  }
  return Z[e ? Z.indexOf(e) : 0];
}
function jc(i) {
  for (let t = Z.indexOf(i) + 1, e = Z.length; t < e; ++t)
    if (bi[Z[t]].common) return Z[t];
}
function uo(i, t, e) {
  if (!e) i[t] = !0;
  else if (e.length) {
    let { lo: s, hi: n } = qe(e, t),
      o = e[s] >= t ? e[s] : e[n];
    i[o] = !0;
  }
}
...
var Bt = class extends _t {
  ...
  buildTicks() {
    ...
    return (
      ...
      (this._majorUnit =
        !s.major.enabled || this._unit === "year" ? void 0 : jc(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
...
var Fe = class extends Bt {
  ...
  getValueForPixel(t) {
    let e = this._offsets,
      s = this.getDecimalForPixel(t) / e.factor - e.end;
    return li(this._table, s * this._tableRange + this._minPos, !0);
  }
};
Fe.id = "timeseries";
...
function Xc({ dataChecksum: i, labels: t, values: e }) {
  return {
    ...
    getChart: function () {
      return Cs.getChart(this.$refs.canvas);
    },
  };
}
